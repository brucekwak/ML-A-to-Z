...
plot_confusion_matrix(cm, target_names=[0, 1], normalize = False)  # function is placed at below


# Fitting the Training set results
...
# [Reference] https://www.kaggle.com/grfiv4/plotting-confusion-matrices
